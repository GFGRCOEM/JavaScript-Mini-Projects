...
# Problem Statement: Sorting Algo Visualiser
Design a web application that visualizes sorting algorithms in action. Users should be able to choose a sorting algorithm (e.g., Bubble Sort, Quick Sort, Merge Sort) and see a graphical representation of how the algorithm sorts a list of numbers.
