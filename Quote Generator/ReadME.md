...
Use the quotable.io API which gives you random quotes and have a generate button into your user interface which would help in generating a random quote from the API calls. Make a stunning user interface that would help better interaction with the website.
