...
# Problem Statement: Random Geometric Art Generator

Use geometric shapes like hexagon, pentagon, circle, square, triangle etc to create a geometric.Art that could be Randomly Generated after we press the generate button each and every time.
