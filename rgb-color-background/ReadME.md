...
# Problem Statement: RGB Color background

Create a user interface with input fields where the user can input RGB values (Red, Green, Blue) in the range of 0 to 255. Upon submission, display a corresponding background color using the provided RGB values. Ensure the UI is intuitive and visually appealing, allowing users to experiment with different colors effortlessly.
