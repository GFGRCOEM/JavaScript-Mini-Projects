...
# Problem Statement: Captcha Generator

The user interface should have a generate button which would generate CAPTCHA for the user and he has to enter that capture and validate if it is correct or not.You have to deduce.Method through which CAPTCHA is generated and validated.
