...
# Problem Statement: Pokemon Listing App

All of us are big fans of Pokemon cartoon. So here you have to use the application programming interface or API to generate and take all the pokemons and render them accordingly into your application in form of lists or cards. The cards should have pokemons image, its name and some details about it, like what type of Pokemon it is, what are its moves, etc.
