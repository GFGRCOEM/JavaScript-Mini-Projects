...
# Problem Statement: Quiz Application

Make a basic MCQ Quiz application on Current affairs and General Knowledge. it should contain 20 questions and should provide appropriate result at the end when quiz is submitted. On the result page you should have re-appear for test button. 
To go one step further make a JSON of 50 Questions and randomly select any 20 questions. This helps the user get a new question everytime he reappears the test.
