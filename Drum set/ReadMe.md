...
# Problem Statement: Drum Set

Design a user interface resembling a drum set where users can interact by clicking buttons or pressing corresponding keys. Each button/key should produce a unique drum sound. Users should be able to experience the sensation of playing a drum set through this interface.
