...
# Problem Statement: Random Password Generator

The UI should be in such a way that the user selects the number of characters he wants in the password and get a random password generated. You have all rights to modify the UI and make a creative User Interface.
