...
Make a monthly Expense tracker which tracks income and expense and tells the user about the monthly expenditure. Use some Graphs or charts to render the expense data that the user is producing by using the application.
