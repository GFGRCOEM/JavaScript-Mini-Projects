...
# Problem Statement: Leap Year in given Range of years

The user interface should have a form like structure in which there are 2 inputs, one of the input is starting year and second input is the ending year. And your task is to find all leap years that are lying between these 2 ranges.You have to return errors if user is entering first year as 1999 and second ending year as 1977.
