...
# Problem Statement: Super Tic-Tac-Toe
Design and implement a Super Tic Tac Toe game using HTML, CSS, and JavaScript. Super Tic Tac Toe is an extended version of the classic Tic Tac Toe game, where the board consists of nine smaller Tic Tac Toe boards arranged in a 3x3 grid. To win, a player must win three smaller Tic Tac Toe boards in a row, column, or diagonal. The game should allow two players to take turns and track the overall winner.
