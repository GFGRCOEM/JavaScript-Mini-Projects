...
# Problem Statement: GUI Calculator

Design a graphical user interface (GUI) calculator that allows users to perform basic arithmetic operations (addition, subtraction, multiplication, and division). Users should input numbers and select the operation they want to perform, and the calculator should display the result accurately on the interface. The design should be intuitive and user-friendly, providing a seamless experience for performing calculations.
