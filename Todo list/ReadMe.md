...
Design a simple web-based Todo List application using HTML, CSS, and JavaScript. The application should allow users to:
i)Add new tasks to the list.
ii)Mark tasks as completed.
